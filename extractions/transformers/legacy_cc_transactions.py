"""
Legacy Credit Card transactions transformer.

Transforms legacy CC CSV (from SBI CSV extractor) to ingestable format.
...
class LegacyCCTransactionsTransformer(BaseTransformer):
    """
    Transform legacy CC CSV to ingestable format.

    Legacy format: row_id, date, ser_no, description, amount, intl_amount, intl_currency, card_number
