...
class TransactionAdmin(admin.ModelAdmin):
    ...
    list_filter = ('category', 'bank_account', 'source_file')
...
class FileLoadLogAdmin(admin.ModelAdmin):
    list_display = ('created_at', 'source_file', 'bank_account', 'transaction_count', 'link_source')
...
class AccountLogAdmin(admin.ModelAdmin):
    list_display = ('created_at', 'bank_account', 'action', 'old_value', 'new_value', 'source_file')
    list_filter = ('action', 'created_at')
    ordering = ('-created_at',)
