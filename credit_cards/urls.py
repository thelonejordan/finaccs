...
urlpatterns = [
    ...
    path('api/cc-pdf-extractions/<int:extraction_id>/artifact/', views.pdf_extraction_artifact, name='pdf_extraction_artifact'),
    path('api/cc-pdf-extractions/<int:extraction_id>/preview/', views.pdf_extraction_artifact_preview, name='pdf_extraction_artifact_preview'),
